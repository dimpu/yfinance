...
type Quote struct {
	...
	FiftyTwoWeekRange              *TwoNumberRange `json:"fiftyTwoWeekRange,omitempty"`
	...
	DividendDate                *YahooDate `json:"dividendDate,omitempty"`
	...
	ExpireDate        *YahooDate `json:"expireDate,omitempty"`
...
// QuoteOptions specifies parameters for the Quote API call.
