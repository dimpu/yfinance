...
// QuoteSummaryOptions specifies parameters for the QuoteSummary API call.
type QuoteSummaryOptions struct {
	Formatted bool     `json:"formatted,omitempty"`
	Modules   []string `json:"modules,omitempty"` // module names or "all"
}

// All available QuoteSummary modules.
var allQuoteSummaryModules = []string{
	"assetProfile",
	"balanceSheetHistory",
...
// QuoteSummaryResult holds all optional sub-modules returned by the
...
type QuoteSummaryResult struct {
	...
	Price                             *QuoteSummaryPrice                 `json:"price,omitempty"`
...
// ---------- Fully-defined sub-module structs ----------
...
type AssetProfile struct {
	...
	GovernanceEpochDate *YahooDate      `json:"governanceEpochDate,omitempty"`
	CompensationAsOfEpochDate *YahooDate `json:"compensationAsOfEpochDate,omitempty"`
...
type DefaultKeyStatistics struct {
	...
	LastFiscalYearEnd       *YahooDate `json:"lastFiscalYearEnd,omitempty"`
	NextFiscalYearEnd       *YahooDate `json:"nextFiscalYearEnd,omitempty"`
	MostRecentQuarter       *YahooDate `json:"mostRecentQuarter,omitempty"`
...
// QuoteSummaryPrice provides price data within quote summary.
type QuoteSummaryPrice struct {
	...
	RegularMarketTime         *YahooDate `json:"regularMarketTime,omitempty"`
...
// QuoteSummaryEarnings provides earnings data within quote summary.
...
type EarningsChart struct {
	...
	EarningsDate []YahooDate              `json:"earningsDate,omitempty"`
}
...
// BalanceSheetHistoryQuarterly (stub).
...
// CashflowStatementHistory (stub).
type CashflowStatementHistory struct {
	MaxAge int64 `json:"maxAge"`
}

// CashflowStatementHistoryQuarterly (stub).
type CashflowStatementHistoryQuarterly struct {
	MaxAge int64 `json:"maxAge"`
}

// EarningsHistory (stub).
...
// IncomeStatementHistory (stub).
type IncomeStatementHistory struct {
	MaxAge int64 `json:"maxAge"`
}

// IncomeStatementHistoryQuarterly (stub).
...
// InsiderHolders (stub).
type InsiderHolders struct {
	MaxAge int64 `json:"maxAge"`
}

// InsiderTransactions (stub).
type InsiderTransactions struct {
	MaxAge int64 `json:"maxAge"`
}

// InstitutionOwnership (stub).
type InstitutionOwnership struct {
	MaxAge int64 `json:"maxAge"`
}

// MajorDirectHolders (stub).
type MajorDirectHolders struct {
	MaxAge int64 `json:"maxAge"`
}

// MajorHoldersBreakdown (stub).
type MajorHoldersBreakdown struct {
	MaxAge int64 `json:"maxAge"`
}

// NetSharePurchaseActivity (stub).
type NetSharePurchaseActivity struct {
	MaxAge int64 `json:"maxAge"`
}

// QuoteTypeSummary provides quote type information.
...
func resolveModules(opts *QuoteSummaryOptions) []string {
	...
	for _, m := range opts.Modules {
		if m == "all" {
			return allQuoteSummaryModules
		}
	}
	return opts.Modules
}

// quoteSummaryParseError is returned when the result array is empty.
